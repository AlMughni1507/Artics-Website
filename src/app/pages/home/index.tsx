...
function HeroSection() {
    ...
    const gridPattern = useMemo(() => {
        const size = 50; // Size of each square (slightly larger)
        const cols = 30; // Pattern width: 1500px
        const rows = 20; // Pattern height: 1000px
        ...
        for (let i = 0; i < cols; i++) {
            for (let j = 0; j < rows; j++) {
                ...
                // Increase chance to ~25% so the 3 colors are more prominent
                if (pseudoRandom < 0.25) {
                    // Map pseudoRandom (0 to 0.25) to an index (0, 1, or 2)
        ...
        >
            ...
            >
                ...
                <h1 className="hero-heading">
                    <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0 }}>Think</motion.span>{" "}
                    <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}>Big</motion.span>{" "}
                    <motion.span
                        className="highlight"
                        style={{
                            background: "linear-gradient(#1E65A7, #1E65A7) no-repeat left center",
                        }}
                        initial={{ opacity: 0, y: 20, backgroundSize: "0% 100%" }}
                        animate={{ opacity: 1, y: 0, backgroundSize: "100% 100%" }}
                        transition={{
                            opacity: { duration: 0.6, delay: 0.3 },
                            y: { duration: 0.6, delay: 0.3 },
                            backgroundSize: { duration: 0.8, delay: 0.9, ease: "easeInOut" }
                        }}
                    >Dream</motion.span>{" "}
                    <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.45 }}>Wild</motion.span>
                    <br />
                    <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.6 }}>Never</motion.span>{" "}
                    <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.75 }}>Stop</motion.span>{" "}
                    <motion.span
                        className="highlight"
                        style={{
                            background: "linear-gradient(#1E65A7, #1E65A7) no-repeat left center",
                        ...
                        transition={{
                            ...
                            backgroundSize: { duration: 0.8, delay: 1.5, ease: "easeInOut" }
                        }}
            ...
            {/* 3D Models — single optimized canvas */}
            <HeroModels />
            ...
            <div
                style={{
                    ...
                    height: "414px",
                    background:
                        "linear-gradient(180deg, rgba(12, 17, 36, 0) 0%, rgba(12, 17, 36, 1) 100%)",
                    pointerEvents: "none",
                    zIndex: 8,
                }}
            />
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    <StatCard
                        ...
                        duration={2000}
                        title="Total Project"
                        description={<>We handling more than 200<br />Project and run smoothly</>}
                    />
...
function CampaignsInActionSection() {
    ...
    const campaigns = [
        ...
        },
        {
            title: "Video Production",
            description: "Lorem ipsum dolor sit amet consectetur.",
            videoUrl: "⁠https://www.youtube.com/watch?v=KwYdFybhoII",
        },
    ];
